...
namespace Dbscan
{
  ...
  public static class Dbscan
  {
	...
	private static Cluster<T> BuildCluster<T>(ISpatialIndex<PointInfo<T>> index, PointInfo<T> point, IReadOnlyList<PointInfo<T>> neighborhood, decimal epsilon, int minimumPointsPerCluster)
		where T : IPointData
	{
